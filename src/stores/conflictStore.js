    ...
    actions: {
        async fetchConflicts() {
            ...
            try {
                ...
                this.error ='Error al cargat los conflictos'
            } finally {
                this.loading = false
            }
        },

        async fetchConflictsById(id) {
            this.loading = true
            try{
                const responde = await getConflictById(id)
